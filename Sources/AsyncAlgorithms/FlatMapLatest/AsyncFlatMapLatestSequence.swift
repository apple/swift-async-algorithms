...
extension AsyncSequence where Self: Sendable {
  ...
  where Failure == Never, T.Element: Sendable, Element: Sendable {
    return AsyncFlatMapLatestSequence(
      self.mapError { _ -> T.Failure in
        fatalError()
      },
      transform: transform
    )
...
@available(AsyncAlgorithms 1.3, *)
struct AsyncFlatMapLatestSequence<Base: AsyncSequence & Sendable, Inner: AsyncSequence & Sendable>: AsyncSequence,
  Sendable
