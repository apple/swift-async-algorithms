...
public struct AsyncFlatMapLatestSequence<Base: AsyncSequence & Sendable, Inner: AsyncSequence & Sendable>: AsyncSequence, Sendable where Base.Element: Sendable, Inner.Element: Sendable {
  ...
  public struct Iterator: AsyncIteratorProtocol, Sendable {
    fileprivate let storage: FlatMapLatestStorage<Base, Inner>
...
@available(AsyncAlgorithms 1.0, *)
private final class FlatMapLatestStorage<Base: AsyncSequence & Sendable, Inner: AsyncSequence & Sendable>: @unchecked Sendable where Base.Element: Sendable, Inner.Element: Sendable {
...
@available(AsyncAlgorithms 1.0, *)
private struct FlatMapLatestStateMachine<Base: AsyncSequence & Sendable, Inner: AsyncSequence & Sendable> where Base.Element: Sendable, Inner.Element: Sendable {
  typealias Element = Inner.Element
